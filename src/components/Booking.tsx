...
const BOOKING_COM_URL =
  "https://www.booking.com/hotel/pt/tapadinho-nature-and-pool-countryside-villa.en-gb.html";
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center justify-center w-72 px-8 py-4 bg-[#FF5A5F] hover:bg-[#e54850] text-white rounded-lg text-lg transition-colors shadow-lg hover:shadow-xl"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center w-72 px-8 py-4 bg-[#003580] hover:bg-[#00264d] text-white rounded-lg text-lg transition-colors shadow-lg hover:shadow-xl"
          >
            <svg
              className="w-6 h-6 mr-2"
              viewBox="0 0 24 24"
